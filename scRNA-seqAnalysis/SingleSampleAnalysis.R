...
# ------------
library(scran)
g02 <- buildSNNGraph(sce.hvg, k=20, use.dimred = 'PCA') # need to further decide what k to use
...
sce$label <- factor(clust02) # label the original dataset
sce.hvg$label <- factor(clust02)
